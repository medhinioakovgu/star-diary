...
const handleRefreshPress = () => {
  ...
  const runDailyDossierUpdate = async (todayMessages: Message[]) => {
    try {
      ...
      // Always regenerate the magazine after each day's update so the demo can
    // show a magazine at any point. The latest version overwrites the previous.
    // (Pre-demo relaxation: paper protocol is to run only on Day 7.)
